...
function setTitleLayout(titleText, titleAlign) {
    const normalizedTitle = titleText.trim();
    const resolvedAlign = titleAlign !== null && titleAlign !== void 0 ? titleAlign : (normalizedTitle.length >= TITLE_JUSTIFY_MIN_CHARS ? "justify" : "center");
...
function renderSlideContent(slide) {
    ...
    setTextLayout(true);
    content.innerText = ((_a = slide.content) !== null && _a !== void 0 ? _a : "").trim();
}
